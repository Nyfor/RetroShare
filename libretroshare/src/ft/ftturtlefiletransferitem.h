...
class RsTurtleFileRequestItem: public RsTurtleGenericTunnelItem
{
	public:
		...
		bool shouldStampTunnel() const override { return false ; }
		Direction travelingDirection() const override { return DIRECTION_SERVER ; }
