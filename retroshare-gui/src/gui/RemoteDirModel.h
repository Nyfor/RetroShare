...
class TreeStyle_RDM: public RetroshareDirModel
{
	...
	protected:
		...
		QVariant displayRole(const DirDetails&,int) const override ;
		QVariant sortRole(const QModelIndex&,const DirDetails&,int) const override ;
